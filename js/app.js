$(document).ready(function() {
    ...
    function theGuysSection() {
        ...
        //Ricardo Quintas
        myData.push(createGuy("Ricardo Quintas (clarinet)", "Plays the Clarinet. He learned music at the Jazz School of HCP (Hot Club de Portugal). Works as a frelance IT consultant around the world.", "", "img/thumbs_pb/thumb_ricardoquintas.jpg"));
    ...
    function createGuy(name, desc, www, img) {
        ...
        obj.img = img;
        obj.title = "<span class='title'>" + name + "</span><br>";

        if (www) {
            obj.title += "<a class='www' target='_blank' href='" + www + "'>" + www + "</a><br>";
        }
